...
?>
    ...
    <? include("includes/head.html"); ?>
            ...
            <?php if ($submitted) : ?>
                ...
                <?php
                    /* For loop for this is completely pointless, but only iterate once since the array is already sorted
                    and we only need the last value */

                    for ($i = 0; $i < 1; $i++) {
                        $value = end($clientInfo);
                        $key = array_search($value, $clientInfo);
                    }
                ?>
